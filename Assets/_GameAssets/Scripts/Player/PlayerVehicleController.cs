...
public class PlayerVehicleController : NetworkBehaviour
{
    ...
    private void UpdateSuspension()
    {
        foreach (WheelType id in _springDatas.Keys)
        {
            ...
            _vehicleRigidbody.AddForceAtPosition(transform.up * force, GetSpringPosition(id));
        }
    }
    ...
    private void UpdateSteering()
    {
        foreach (WheelType wheelType in _wheels)
        {
            ...
            Vector3 force = slideDirection * desiredAcceleration * _vehicleSettings.TireMass;
    ...
    public float GetSpringLength(WheelType wheelType)
    {
